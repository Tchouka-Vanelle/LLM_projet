...
''' A1: utiliser docker compose
D1:creer une bdd, creer un schema, tjs en lien avec la finance  
(le rapport avec docker compose et la bdd  de la qstion A1 ???).
on peut faire l'PAI en spring boot, ou node ou express ouetc .. '''